...
dados$classe = factor(dados$classe, levels = c('4', '2'), labels = c(1, 0))
```
...
As variáveis preditoras a seguir assumem valores em uma escala ordinal de 1 a 10. São elas: Espessura de aglomerado, Uniformidade do tamanhoda célula, Uniformidade da forma celular, Adesão marginal, Tamanho de célula epitelial única, Núcleos nus, Cromatina Suave, Nucléolos normais, Mitoses.

A variável resposta *classe* foi codificada como sendo:\

0: Não Câncer (Tumor benigno);\

1: Câncer (Tumor maligno).
